        ...
        <div className='text-center space-y-8'>
          ...
          <div className='flex flex-col sm:flex-row justify-center pt-4 gap-4 sm:gap-8 w-full max-w-2xl mx-auto'>
            <Link href='#solutions' className='flex justify-center'>
              <Button
                size='lg'
                className='bg-accent hover:bg-accent/90 text-accent-foreground px-6 py-6 font-semibold cursor-pointer flex justify-between items-center w-auto min-w-[180px] glow-blue animate-pulse-glow'>
                Fractional Services
